...
public class CameraActivity extends AppCompatActivity implements Detector.DetectorListener {
    ...
    // Handler to schedule bitmap captures
    private Handler handler = new Handler(Looper.getMainLooper());
    private Runnable bitmapCaptureRunnable;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Define the bitmap capture runnable
        bitmapCaptureRunnable = new Runnable() {
            @Override
            public void run() {
                if (isRecording) {
                    captureBitmap();
    ...
    public void captureVideo() {
        ...
        if (recording1 != null) {
            ...
            recording = null;
            isRecording = false;
            handler.removeCallbacks(bitmapCaptureRunnable);
            return;
        }
        ...
        recording = videoCapture.getOutput().prepareRecording(CameraActivity.this, options).withAudioEnabled().start(ContextCompat.getMainExecutor(CameraActivity.this), videoRecordEvent -> {
            if (videoRecordEvent instanceof VideoRecordEvent.Start) {
                ...
                isRecording = true;
                handler.post(bitmapCaptureRunnable); // Start capturing bitmaps
                ...
                isRecording = false;
                handler.removeCallbacks(bitmapCaptureRunnable);
                Intent intent = new Intent(CameraActivity.this, DataOutput.class);
    ...
    private void captureBitmap() {
        previewView.post(() -> {
            ...
            if (bitmap != null) {
                ...
                Log.d("BitmapCapture", "Bitmap captured: " + bitmap);
            }
        });
    }
